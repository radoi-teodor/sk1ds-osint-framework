...
return [
    ...
    */
    ...
    'entity_types' => [
        ...
        'username' => ['label' => 'Username', 'color' => '#5ec8ff', 'shape' => 'round-rectangle', 'icon' => '@'],
        'password' => ['label' => 'Password', 'color' => '#ff4d6d', 'shape' => 'round-tag', 'icon' => '🔐'],
        'breach' => ['label' => 'Breach', 'color' => '#8b0000', 'shape' => 'round-octagon', 'icon' => '💀'],
